      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-black">Mentions Légales</h1>
          </div>
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8 bg-gray-50 rounded-xl p-6">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-black mb-2">Éditeur du site</h2>
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-3">
                  Pour toute question concernant le site ou vos données personnelles, 
          ...
          <section className="mb-8 bg-gray-50 rounded-xl p-6">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-black mb-2">Hébergement</h2>
                <p className="text-gray-700 mb-2">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black mb-4">Propriété intellectuelle</h2>
            <p className="text-gray-700 mb-4">
              Le contenu de ce site (structure, textes, logiciels, graphismes, etc.) est la propriété 
              de SeenIt, sauf mention contraire.
            </p>
            <p className="text-gray-700 mb-4">
              Les données relatives aux films et séries sont fournies par{' '}
              <strong>The Movie Database (TMDB)</strong>. Ce produit utilise l'API TMDB mais n'est ni 
              cautionné ni certifié par TMDB.
            </p>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-bold text-black mb-4">Responsabilité</h2>
            <p className="text-gray-700 mb-4">
              SeenIt ne saurait être tenu responsable des erreurs ou omissions dans les informations 
              diffusées sur le site, ni des dommages directs ou indirects résultant de l'utilisation 
              du site.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-xl font-bold text-black mb-4">Liens hypertextes</h2>
            <p className="text-gray-700 mb-4">
              Le site peut contenir des liens vers d'autres sites. SeenIt n'exerce aucun contrôle 
              sur ces sites et décline toute responsabilité quant à leur contenu.
            </p>
          </section>

          <section className="bg-gray-100 rounded-xl p-6">
            <h2 className="text-xl font-bold text-black mb-4">Droit applicable</h2>
