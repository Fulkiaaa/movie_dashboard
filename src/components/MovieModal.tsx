...
export default function MovieModal({ movie, onClose, onUpdate }: MovieModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-[#F6F4F1] w-full md:max-w-4xl md:rounded-2xl rounded-t-3xl max-h-[92vh] md:max-h-[90vh] overflow-y-auto"
      ...
      >
        ...
        <div className="relative h-32 md:h-64">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#F6F4F1] via-[#F6F4F1]/50 to-transparent"></div>
        ...
        <div className="p-4 md:p-6 -mt-16 md:-mt-32 relative">
            ...
            <div className="flex-1 min-w-0">
              <div className="mb-2">
                <div className="flex items-center gap-1.5 mb-1.5">
                  ...
                  {year && (
                    <span className="text-xs md:text-base text-[#B8B0A0]">{year}</span>
                  )}
                </div>
                <h2 className="text-lg md:text-3xl font-bold text-[#0D0D0D] mb-1 line-clamp-2">{displayTitle}</h2>
          ...
          {details.overview && (
            <div className="mb-3 md:mb-6">
              <h3 className="text-sm md:text-lg font-bold text-[#0D0D0D] mb-1 md:mb-2">Synopsis</h3>
              <p className="text-xs md:text-base text-[#0D0D0D] leading-relaxed line-clamp-3 md:line-clamp-none">{details.overview}</p>
            </div>
          )}

          <div className="border-t border-[#E4DED2] pt-3 md:pt-6">
            <h3 className="text-sm md:text-lg font-bold text-[#0D0D0D] mb-2 md:mb-4">Ma collection</h3>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                {userMovie && (
                  ...
                  >
                    <Heart className={`w-3.5 h-3.5 md:w-4 md:h-4 ${isFavorite ? 'fill-[#F6F4F1]' : ''}`} />
