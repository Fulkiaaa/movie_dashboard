      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[#B8B0A0] text-sm">© 2026 Tous droits réservés</span>
            </div>
          </div>
          <div className="flex flex-wrap gap-6">
            <Link href="/dashboard" className="text-[#0D0D0D] hover:text-[#F95C4B] transition-colors text-sm">
              Dashboard
            </Link>
            <Link href="/swipe" className="text-[#0D0D0D] hover:text-[#F95C4B] transition-colors text-sm">
              Swipe
            </Link>
            <Link href="/profile" className="text-[#0D0D0D] hover:text-[#F95C4B] transition-colors text-sm">
              Profil
            </Link>
          </div>
        </div>
        ...
        <div className="border-t border-[#B8B0A0] pt-6 mb-6">
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <Link href="/legal/mentions" className="text-[#0D0D0D] hover:text-[#F95C4B] transition-colors">
              Mentions légales
            </Link>
            <span className="text-[#B8B0A0]">•</span>
            <Link href="/legal/privacy" className="text-[#0D0D0D] hover:text-[#F95C4B] transition-colors">
              Politique de confidentialité
            </Link>
            <span className="text-[#B8B0A0]">•</span>
            <Link href="/legal/terms" className="text-[#0D0D0D] hover:text-[#F95C4B] transition-colors">
              CGU
            </Link>
          </div>
        </div>
        ...
        <div className="bg-[#F6F4F1] border border-[#E4DED2] rounded-lg p-4">
          <div className="flex flex-col md:flex-row items-center justify-center gap-3 text-center">
            ...
            <div className="text-xs text-[#B8B0A0]">
              <p className="font-semibold text-[#0D0D0D] mb-1">Powered by TMDB</p>
              <p>
